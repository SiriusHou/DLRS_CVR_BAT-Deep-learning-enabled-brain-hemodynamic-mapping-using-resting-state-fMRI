function [brnmsk_dspl, brnmsk_clcu, brnmsk] = asl_getBrainMask(imgtpm,imgfile)
% generate brain mask:
...
if imgtpm == 0
    error('Give asl_getBrainMask.m a proper imgtpm')
    imgtpm = 'C:\Users\Zach\OneDrive\College - Grad\Lu Lab\yangCvrCode\spm12\tpm\TPM.nii';
end
...
switch flag_small_fov
    ...
    case 1
        ...
        mask2 = inbrain(imgvol,thre,1,2); % dilate by 1 layer
        brnmsk_clcu = logical(mask1);
        brnmsk_dspl = logical(mask2);
        brnmsk      = logical(inbrain(imgvol,thre,1,1));
end
end
